package be.tftic.webmobile.intro.demo.poo.classBizarre;


import be.tftic.webmobile.intro.demo.poo.abstrait.Cadre;
import be.tftic.webmobile.intro.demo.poo.abstrait.Employe;
import be.tftic.webmobile.intro.demo.poo.interfaces.IRouler;
import be.tftic.webmobile.intro.demo.poo.interfaces.IVolant;
    ...
    public static void main(String[] args) {
        ...
        Cadre cadre = new Cadre("dubosquet", "dominique", 47){
            ...
            public void travailler() {
                System.out.println("Il bosse dur");
            }
        };
        ...
        IRouler rouler = new IRouler() {
            @Override
            public void rouler() {
                System.out.println("je choisi comment rouler en live");
            }
        };
        ...
        IRouler rouler2 = () -> System.out.println("je choisi comment rouler en live");
        rouler2.rouler();
